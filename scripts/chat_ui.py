...
# Même dossier : URL de l'API (Render par défaut, surchargeable via API_URL) et timeout
...
def login_logo() -> str:
    ...
    Image intégrée en base64 : aucun fichier à servir avant la connexion
    """
...
if __name__ == "__main__":
    ...
    # L'image ouvre l'écoute au réseau via GRADIO_SERVER_NAME=0.0.0.0, le local reste en 127.0.0.1
