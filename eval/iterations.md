...
- **Aucune dégradation détectable de la génération** : à juge égal, *faithfulness* passe de 0,865 à 0,86 et *answer relevancy* de 0,812 à 0,81, soit moins que leur bruit propre (respectivement 0,055 et 0,056 d'écart moyen entre deux exécutions identiques). C'était le risque principal — améliorer la recherche en dégradant les réponses.
